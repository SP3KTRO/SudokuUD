...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nuevo.setOnClickListener { board() }
    }
    ...
    private fun board() {
        ...
        var botones = Array(81) { index ->
            val buttonId = resources.getIdentifier("b${index + 1}", "id", packageName)
            findViewById<Button>(buttonId)
        }
        val uno: Button = findViewById(R.id.uno);val dos: Button = findViewById(R.id.dos);val tres: Button = findViewById(R.id.tres);val cuatro: Button = findViewById(R.id.cuatro)
        val cinco: Button = findViewById(R.id.cinco);val seis: Button = findViewById(R.id.seis);val siete: Button = findViewById(R.id.siete);val ocho: Button = findViewById(R.id.ocho);val nueve: Button = findViewById(R.id.nueve)
        val borrar: Button = findViewById(R.id.borrar); val pista: Button = findViewById(R.id.pista); val fin: Button = findViewById(R.id.fin)
        ...
        fun keys(buSelected: Button){
            ...
            buSelected.setOnClickListener {
                ...
                buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green))

                uno.setOnClickListener { buSelected.text="1";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                dos.setOnClickListener { buSelected.text="2";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                tres.setOnClickListener { buSelected.text="3";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                cuatro.setOnClickListener { buSelected.text="4";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                cinco.setOnClickListener { buSelected.text="5";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                seis.setOnClickListener { buSelected.text="6";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                siete.setOnClickListener { buSelected.text="7";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                ocho.setOnClickListener { buSelected.text="8";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                nueve.setOnClickListener { buSelected.text="9";start=0;buSelected.setBackgroundColor(ContextCompat.getColor(this, R.color.green));start=0;buttonColorSize = buttonColor.size.toInt();trats=0 }
                ...
                pista.setOnClickListener {
                    ...
                    if (trys <= 4){
                        ...
                        Toast.makeText(this, "No tienes mas ayudas", Toast.LENGTH_SHORT).show()}
                }
            ...
            if (i != j && i != k && k != j && d != i && d != j && d != k && e != i && e != j && e != k && f != i && f != j && f != k) {
                if (l != m && l != n && n != m && d != l && d != m && d != n && e != l && e != m && e != n && f != l && f != m && f != n && i != l && i != m && i != n && j != l && j != m && j != n && k != l && k != m && k != n) {
                    ...
                    while (a <= random){
                        ...
                        when(r){
                            1 -> {botones[0].text = "";keys(buSelected = botones[0]);botones[0].setBackgroundResource(R.drawable.borde_negro)}
                            2 -> {botones[1].text = "";keys(buSelected = botones[1]);botones[1].setBackgroundResource(R.drawable.borde_negro)}
                            3 -> {botones[2].text = "";keys(buSelected = botones[2]);botones[2].setBackgroundResource(R.drawable.borde_negro)}
                            4 -> {botones[3].text = "";keys(buSelected = botones[3]);botones[3].setBackgroundResource(R.drawable.borde_negro)}
                            5 -> {botones[4].text = "";keys(buSelected = botones[4]);botones[4].setBackgroundResource(R.drawable.borde_negro)}
                            6 -> {botones[5].text = "";keys(buSelected = botones[5]);botones[5].setBackgroundResource(R.drawable.borde_negro)}
                            7 -> {botones[6].text = "";keys(buSelected = botones[6]);botones[6].setBackgroundResource(R.drawable.borde_negro)}
                            8 -> {botones[7].text = "";keys(buSelected = botones[7]);botones[7].setBackgroundResource(R.drawable.borde_negro)}
                            9 -> {botones[8].text = "";keys(buSelected = botones[8]);botones[8].setBackgroundResource(R.drawable.borde_negro)}

                            10 -> {botones[9].text = "";keys(buSelected = botones[9]);botones[9].setBackgroundResource(R.drawable.borde_azul)}
                            11 -> {botones[10].text = "";keys(buSelected = botones[10]);botones[10].setBackgroundResource(R.drawable.borde_azul)}
                            12 -> {botones[11].text = "";keys(buSelected = botones[11]);botones[11].setBackgroundResource(R.drawable.borde_azul)}
                            13 -> {botones[12].text = "";keys(buSelected = botones[12]);botones[12].setBackgroundResource(R.drawable.borde_azul)}
                            14 -> {botones[13].text = "";keys(buSelected = botones[13]);botones[13].setBackgroundResource(R.drawable.borde_azul)}
                            15 -> {botones[14].text = "";keys(buSelected = botones[14]);botones[14].setBackgroundResource(R.drawable.borde_azul)}
                            16 -> {botones[15].text = "";keys(buSelected = botones[15]);botones[15].setBackgroundResource(R.drawable.borde_azul)}
                            17 -> {botones[16].text = "";keys(buSelected = botones[16]);botones[16].setBackgroundResource(R.drawable.borde_azul)}
                            18 -> {botones[17].text = "";keys(buSelected = botones[17]);botones[17].setBackgroundResource(R.drawable.borde_azul)}

                            19 -> {botones[18].text = "";keys(buSelected = botones[18]);botones[18].setBackgroundResource(R.drawable.borde_negro)}
                            20 -> {botones[19].text = "";keys(buSelected = botones[19]);botones[19].setBackgroundResource(R.drawable.borde_negro)}
                            21 -> {botones[20].text = "";keys(buSelected = botones[20]);botones[20].setBackgroundResource(R.drawable.borde_negro)}
                            22 -> {botones[21].text = "";keys(buSelected = botones[21]);botones[21].setBackgroundResource(R.drawable.borde_negro)}
                            23 -> {botones[22].text = "";keys(buSelected = botones[22]);botones[22].setBackgroundResource(R.drawable.borde_negro)}
                            24 -> {botones[23].text = "";keys(buSelected = botones[23]);botones[23].setBackgroundResource(R.drawable.borde_negro)}
                            25 -> {botones[24].text = "";keys(buSelected = botones[24]);botones[24].setBackgroundResource(R.drawable.borde_negro)}
                            26 -> {botones[25].text = "";keys(buSelected = botones[25]);botones[25].setBackgroundResource(R.drawable.borde_negro)}
                            27 -> {botones[26].text = "";keys(buSelected = botones[26]);botones[26].setBackgroundResource(R.drawable.borde_negro)}

                            28 -> {botones[27].text = "";keys(buSelected = botones[27]);botones[27].setBackgroundResource(R.drawable.borde_azul)}
                            29 -> {botones[28].text = "";keys(buSelected = botones[28]);botones[28].setBackgroundResource(R.drawable.borde_azul)}
                            30 -> {botones[29].text = "";keys(buSelected = botones[29]);botones[29].setBackgroundResource(R.drawable.borde_azul)}
                            31 -> {botones[30].text = "";keys(buSelected = botones[30]);botones[30].setBackgroundResource(R.drawable.borde_azul)}
                            32 -> {botones[31].text = "";keys(buSelected = botones[31]);botones[31].setBackgroundResource(R.drawable.borde_azul)}
                            33 -> {botones[32].text = "";keys(buSelected = botones[32]);botones[32].setBackgroundResource(R.drawable.borde_azul)}
                            34 -> {botones[33].text = "";keys(buSelected = botones[33]);botones[33].setBackgroundResource(R.drawable.borde_azul)}
                            35 -> {botones[34].text = "";keys(buSelected = botones[34]);botones[34].setBackgroundResource(R.drawable.borde_azul)}
                            36 -> {botones[35].text = "";keys(buSelected = botones[35]);botones[35].setBackgroundResource(R.drawable.borde_azul)}

                            37 -> {botones[36].text = "";keys(buSelected = botones[36]);botones[36].setBackgroundResource(R.drawable.borde_negro)}
                            38 -> {botones[37].text = "";keys(buSelected = botones[37]);botones[37].setBackgroundResource(R.drawable.borde_negro)}
                            39 -> {botones[38].text = "";keys(buSelected = botones[38]);botones[38].setBackgroundResource(R.drawable.borde_negro)}
                            40 -> {botones[39].text = "";keys(buSelected = botones[39]);botones[39].setBackgroundResource(R.drawable.borde_negro)}
                            41 -> {botones[40].text = "";keys(buSelected = botones[40]);botones[40].setBackgroundResource(R.drawable.borde_negro)}
                            42 -> {botones[41].text = "";keys(buSelected = botones[41]);botones[41].setBackgroundResource(R.drawable.borde_negro)}
                            43 -> {botones[42].text = "";keys(buSelected = botones[42]);botones[42].setBackgroundResource(R.drawable.borde_negro)}
                            44 -> {botones[43].text = "";keys(buSelected = botones[43]);botones[43].setBackgroundResource(R.drawable.borde_negro)}
                            45 -> {botones[44].text = "";keys(buSelected = botones[44]);botones[44].setBackgroundResource(R.drawable.borde_negro)}

                            46 -> {botones[45].text = "";keys(buSelected = botones[45]);botones[45].setBackgroundResource(R.drawable.borde_azul)}
                            47 -> {botones[46].text = "";keys(buSelected = botones[46]);botones[46].setBackgroundResource(R.drawable.borde_azul)}
                            48 -> {botones[47].text = "";keys(buSelected = botones[47]);botones[47].setBackgroundResource(R.drawable.borde_azul)}
                            49 -> {botones[48].text = "";keys(buSelected = botones[48]);botones[48].setBackgroundResource(R.drawable.borde_azul)}
                            50 -> {botones[49].text = "";keys(buSelected = botones[49]);botones[49].setBackgroundResource(R.drawable.borde_azul)}
                            51 -> {botones[50].text = "";keys(buSelected = botones[50]);botones[50].setBackgroundResource(R.drawable.borde_azul)}
                            52 -> {botones[51].text = "";keys(buSelected = botones[51]);botones[51].setBackgroundResource(R.drawable.borde_azul)}
                            53 -> {botones[52].text = "";keys(buSelected = botones[52]);botones[52].setBackgroundResource(R.drawable.borde_azul)}
                            54 -> {botones[53].text = "";keys(buSelected = botones[53]);botones[53].setBackgroundResource(R.drawable.borde_azul)}

                            55 -> {botones[54].text = "";keys(buSelected = botones[54]);botones[54].setBackgroundResource(R.drawable.borde_negro)}
                            56 -> {botones[55].text = "";keys(buSelected = botones[55]);botones[55].setBackgroundResource(R.drawable.borde_negro)}
                            57 -> {botones[56].text = "";keys(buSelected = botones[56]);botones[56].setBackgroundResource(R.drawable.borde_negro)}
                            58 -> {botones[57].text = "";keys(buSelected = botones[57]);botones[57].setBackgroundResource(R.drawable.borde_negro)}
                            59 -> {botones[58].text = "";keys(buSelected = botones[58]);botones[58].setBackgroundResource(R.drawable.borde_negro)}
                            60 -> {botones[59].text = "";keys(buSelected = botones[59]);botones[59].setBackgroundResource(R.drawable.borde_negro)}
                            61 -> {botones[60].text = "";keys(buSelected = botones[60]);botones[60].setBackgroundResource(R.drawable.borde_negro)}
                            62 -> {botones[61].text = "";keys(buSelected = botones[61]);botones[61].setBackgroundResource(R.drawable.borde_negro)}
                            63 -> {botones[62].text = "";keys(buSelected = botones[62]);botones[62].setBackgroundResource(R.drawable.borde_negro)}

                            64 -> {botones[63].text = "";keys(buSelected = botones[63]);botones[63].setBackgroundResource(R.drawable.borde_azul)}
                            65 -> {botones[64].text = "";keys(buSelected = botones[64]);botones[64].setBackgroundResource(R.drawable.borde_azul)}
                            66 -> {botones[65].text = "";keys(buSelected = botones[65]);botones[65].setBackgroundResource(R.drawable.borde_azul)}
                            67 -> {botones[66].text = "";keys(buSelected = botones[66]);botones[66].setBackgroundResource(R.drawable.borde_azul)}
                            68 -> {botones[67].text = "";keys(buSelected = botones[67]);botones[67].setBackgroundResource(R.drawable.borde_azul)}
                            69 -> {botones[68].text = "";keys(buSelected = botones[68]);botones[68].setBackgroundResource(R.drawable.borde_azul)}
                            70 -> {botones[69].text = "";keys(buSelected = botones[69]);botones[69].setBackgroundResource(R.drawable.borde_azul)}
                            71 -> {botones[70].text = "";keys(buSelected = botones[70]);botones[70].setBackgroundResource(R.drawable.borde_azul)}
                            72 -> {botones[71].text = "";keys(buSelected = botones[71]);botones[71].setBackgroundResource(R.drawable.borde_azul)}

                            73 -> {botones[72].text = "";keys(buSelected = botones[72]);botones[72].setBackgroundResource(R.drawable.borde_negro)}
                            74 -> {botones[73].text = "";keys(buSelected = botones[73]);botones[73].setBackgroundResource(R.drawable.borde_negro)}
                            75 -> {botones[74].text = "";keys(buSelected = botones[74]);botones[74].setBackgroundResource(R.drawable.borde_negro)}
                            76 -> {botones[75].text = "";keys(buSelected = botones[75]);botones[75].setBackgroundResource(R.drawable.borde_negro)}
                            77 -> {botones[76].text = "";keys(buSelected = botones[76]);botones[76].setBackgroundResource(R.drawable.borde_negro)}
                            78 -> {botones[77].text = "";keys(buSelected = botones[77]);botones[77].setBackgroundResource(R.drawable.borde_negro)}
                            79 -> {botones[78].text = "";keys(buSelected = botones[78]);botones[78].setBackgroundResource(R.drawable.borde_negro)}
                            80 -> {botones[79].text = "";keys(buSelected = botones[79]);botones[79].setBackgroundResource(R.drawable.borde_negro)}
                            81 -> {botones[80].text = "";keys(buSelected = botones[80]);botones[80].setBackgroundResource(R.drawable.borde_negro)}
                        }
                        a++
                    }
